document.addEventListener('DOMContentLoaded', () => {
  ...
  // Open modal on triggers
  document.addEventListener('click', (e) => {
    if (e.target.classList.contains('btn-consultation-trigger')) {
      e.preventDefault();
      ...
      document.getElementById('booking-date').min = tomorrowStr;
    }
  });
  ...
  if (consultationForm) {
    consultationForm.addEventListener('submit', (e) => {
      ...
      let isValid = true;
      const inputs = consultationForm.querySelectorAll('.form-input');
